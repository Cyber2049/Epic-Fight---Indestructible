...
public class GuardAnimations {
    ...
    private static void build() {
        ...
        MOB_DUAL_SWORD_GUARD = new CustomGuardAnimation("guard/guard_dualsword",
                "epicfight:biped/skill/guard_dualsword_hit", biped);
        MOB_COUNTER_ATTACK = new AttackAnimation(0.3F, 0.08F, 0.1F, 0.15F, 0.525F, ColliderPreset.FIST, biped.legR, "guard/counter", biped)
                ...
                .addProperty(AnimationProperty.AttackPhaseProperty.SOURCE_TAG, Set.of(EpicFightDamageType.COUNTER))
        ...
        if(ModList.get().isLoaded("yamatomoveset")){
            MOB_YAMATO_GUARD = new CustomGuardAnimation("guard/guard_yamato",
                    "yamatomoveset:biped/yamato/yamato_guard_hit", biped);
        }
        ...
        if(ModList.get().isLoaded("wom")){
            ...
            MOB_HERRSCHER_GUARD = new CustomGuardAnimation("guard/guard_herrscher",
                    "indestructible:guard/shield_hit_left", biped);
        }

        SHIELD_HIT = new GuardAnimation(0.05f,"guard/shield_hit_left",biped);
        MOB_SHIELD_GUARD = new CustomGuardAnimation("guard/guard_shield",
                "indestructible:guard/shield_hit_left",biped,true);
    }
